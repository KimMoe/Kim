...
public class Tools {
    ...
    public void setModluler(int id, int m1, int m2, int m3, int m4 ,int m5) throws SQLException
    {
        Connection con = null;
    ...
    ResultSet rs =  null;
      ...
      try{
            String sql = "UPDATE user SET  user_m1=?,user_m2=?,user_m3=?,user_m4=?,user_m5=? WHERE user_id=?";
    ...
    public void sok(String Navn) throws SQLException {
        String navn = Navn;
